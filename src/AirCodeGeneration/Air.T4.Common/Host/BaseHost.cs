...
namespace Air.T4.Common.Host
{
    ...
    /// </summary>
    [Serializable]
    public class BaseHost : ITextTemplatingEngineHost
    {
        /// <summary>
        /// 正在处理的文本模板的路径和文件名
        /// </summary>
        ...
        /// <summary>
        /// 解析程序集引用
        /// The engine calls this method to resolve assembly references used in the generated transformation class
        /// project and for the optional assembly directive if the user has specified it in the text template. 
        /// This method can be called 0, 1, or more times.
        /// 该引擎调用此方法来解决在生成的改造类项目所使用的程序集引用和可选的指令集，
        /// 如果用户在文本中指定它的模板。这种方法可调用0，1次或多次。
        /// </summary>
        ...
        /// The engine calls this method based on the directives the user has specified in the text template. 
        /// This method can be called 0, 1, or more times.
        /// </summary>
        ...
        /// <returns></returns>
        public virtual string ResolvePath(string fileName)
        {
            if (fileName == null)
            {
